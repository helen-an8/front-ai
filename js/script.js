...
// chart
  ...
  const observer = new IntersectionObserver((entries, obs) => {
    if (entries[0].isIntersecting) {
      ...
      script.src = "https://cdn.jsdelivr.net/npm/echarts@5.5.0/dist/echarts.min.js"; // أحدث إصدار خفيف
      script.onload = () => {
        const growthChart = echarts.init(chartContainer);
        const option = {
          ...
          grid: {
            left: 0, right: 0, top: 60, bottom: 0, containLabel: true
          },
          xAxis: {
            type: 'category',
            boundaryGap: false,
          ...
          yAxis: [
            ...
            },
            {
              ...
              position: 'right',
              axisLine: { lineStyle: { color: '#888888' } },
              axisLabel: { formatter: '${value}K', color: '#cccccc' },
          ...
          series: [
            {
              ...
              areaStyle: {
                color: {
                  ...
                  x: 0, y: 0, x2: 0, y2: 1,
                  colorStops: [
                    { offset: 0, color: 'rgba(87, 181, 231, 0.4)' },
      ...
      obs.disconnect(); // توقف عن المراقبة بعد أول تحميل
    }
  });
